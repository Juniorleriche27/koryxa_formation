...
VALUES (
    ...
    'Un projet complet comprenant la préparation des données, l’analyse exploratoire, les tests statistiques, la segmentation client, la prévision des ventes, l’évaluation des modèles et la formulation de recommandations métier.',
    FALSE,
    5
)
...
WITH target_course AS (
    ...
    VALUES
    (0,'Fondations du raisonnement statistique','Population, échantillon, variables, types de données, biais, causalité et démarche scientifique.','2h00',2,
    ...
    (1,'Statistiques descriptives avec Python','Mesures de tendance centrale, dispersion, position, forme et synthèse avec pandas et NumPy.','2h30',2.5,
    ...
    (2,'Visualiser les distributions','Histogrammes, boxplots, densité, valeurs atypiques, transformations et lecture critique des graphiques.','2h30',2.5,
    ...
    (3,'Probabilités et variables aléatoires','Probabilités conditionnelles, indépendance, espérance, variance et lois usuelles.','2h30',2.5,
    ...
    (4,'Échantillonnage et estimation','Méthodes d’échantillonnage, erreur standard, bootstrap et intervalles de confiance.','2h30',2.5,
    ...
    (5,'Tests d’hypothèses','Hypothèses nulle et alternative, p-value, erreurs de type I et II, puissance et choix du test.','3h00',3,
    ...
    (6,'Comparer des groupes','Tests t, Mann-Whitney, ANOVA, chi-deux, tailles d’effet et comparaisons multiples.','2h30',2.5,
    ...
    (7,'Corrélation et régression linéaire','Covariance, Pearson, Spearman, régression simple et multiple, hypothèses et interprétation.','3h00',3,
    ...
    (8,'Segmentation des clients','Préparation des variables, standardisation, K-means, choix du nombre de groupes et profilage.','2h30',2.5,
    ...
    (9,'Prévision des ventes','Séries temporelles, tendance, saisonnalité, validation temporelle, baseline et modèles de prévision.','3h00',3,
    ...
    (10,'Évaluer et interpréter les modèles','Séparation train/test, validation croisée, métriques, surapprentissage, importance et limites.','2h30',2.5,
    ...
    (11,'Communiquer une étude data science','Reproductibilité, notebook professionnel, narration analytique, recommandations, éthique et remise du projet.','3h00',3,
...
BEGIN
    ...
    IF module_count<>12 OR hour_total<>30 OR published_count<>0 THEN

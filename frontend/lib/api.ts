...
export const commerceAPI = {
  ...
  initiateKoryxaPay: (payload: { product_code: string; item_type?: "course" | "pack"; partner_code?: string | null; customer_name: string; customer_phone: string; purchase_attempt_id: string }) =>

    ...
    <main className="min-h-screen bg-[#f4f7f2] text-[#10251d]">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-12 lg:grid-cols-[1.05fr_.75fr] lg:items-center">
          <div>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <PurchaseCourseLink courseSlug="sql-data-analyst" className="inline-flex min-h-12 items-center justify-center gap-2 rounded-2xl bg-emerald-300 px-6 py-4 text-sm font-black text-[#10251d] transition hover:-translate-y-0.5 hover:bg-white">Commencer la formation <ArrowRight size={17}/></PurchaseCourseLink>
      ...
      <section id="prix" className="bg-[#10251d] px-4 py-20 text-white sm:px-6 lg:px-8 lg:py-24">
        <div className="mx-auto grid max-w-6xl gap-8 rounded-[2rem] border border-white/10 bg-white/[.06] p-7 sm:p-10 lg:grid-cols-[1fr_auto] lg:items-center">
          ...
          <PurchaseCourseLink courseSlug="sql-data-analyst" className="inline-flex min-h-12 items-center justify-center gap-2 rounded-2xl bg-emerald-300 px-6 py-4 text-sm font-black text-[#10251d] transition hover:bg-white">Commencer la formation <ArrowRight size={17}/></PurchaseCourseLink>
        </div>
      </section>
    </main>
  );

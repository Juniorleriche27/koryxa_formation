    ...
    <main className="kx-dark-page">
      ...
      <nav className="fixed inset-x-0 top-0 z-50 border-b border-white/10 bg-[#07111f]/78 backdrop-blur-2xl">
        <div className="kx-container flex h-16 items-center justify-between gap-4">
          ...
          <Link href={LEARNER_ACCESS_URL} className="inline-flex h-10 items-center justify-center rounded-2xl bg-white px-4 text-sm font-black text-slate-950 shadow-lg shadow-white/10 transition hover:-translate-y-0.5 hover:bg-blue-50 hover:text-blue-700">
            Espace apprenant
          </Link>
        </div>
      </nav>
        ...
        <div className="kx-container relative">
          <div className="mx-auto max-w-5xl text-center">
            ...
            <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.24 }} className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
              <Link href={purchaseUrl} className="inline-flex min-h-12 items-center justify-center gap-2 rounded-2xl bg-blue-600 px-7 py-4 text-base font-black text-white shadow-glow transition hover:-translate-y-0.5 hover:bg-blue-500">
                Commencer la formation <ArrowRight size={19} />
              </Link>
          ...
          <div className="mx-auto max-w-4xl overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.08] p-5 shadow-2xl shadow-blue-950/30 backdrop-blur-xl sm:p-8 lg:p-10">
            <div className="grid gap-8 lg:grid-cols-[1fr_22rem] lg:items-center">
              ...
              <motion.div animate={{ boxShadow: ["0 20px 70px rgba(37,99,235,.18)", "0 28px 90px rgba(37,99,235,.34)", "0 20px 70px rgba(37,99,235,.18)"] }} transition={{ duration: 3, repeat: Infinity }} className="rounded-3xl bg-white p-6 text-slate-950 shadow-soft">
                ...
                <p className="mt-2 text-sm font-semibold text-slate-500">Déjà inscrit ? Utilise ton accès apprenant pour continuer la formation.</p>
                <Link href={purchaseUrl} className="mt-6 inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-2xl bg-blue-600 px-5 py-4 text-sm font-black text-white shadow-lg shadow-blue-600/25 transition hover:-translate-y-0.5 hover:bg-blue-500">
      ...
      <section className="px-4 pb-16 sm:px-6 lg:px-8">
        <div className="kx-container rounded-[2rem] border border-white/10 bg-gradient-to-br from-blue-600 to-cyan-500 p-8 text-center shadow-glow sm:p-12">
          ...
          <Link href={purchaseUrl} className="mt-7 inline-flex min-h-12 items-center justify-center gap-2 rounded-2xl bg-white px-7 py-4 text-base font-black text-blue-700 shadow-lg shadow-blue-950/20 transition hover:-translate-y-0.5 hover:bg-blue-50">

...
const tracks = [
  ...
  },
  {
    ...
    description: "Construisez un assistant documentaire avec Python, embeddings, recherche vectorielle, réponses sourcées et interface Streamlit.",
    objective: "Créer une application RAG fiable et présentable.",
    level: "Débutant technique à intermédiaire",
    format: "12 modules + projet final",
    icon: BrainCircuit,
